<template>
  <div class="relative flex py-5 px-3 shadow-md bg-green-200 cursor-pointer">
    <a href="#" @click.prevent="toDetail" class="">
      <a class="absolute top-2 right-2 hover:text-red-500 z-30" @click.stop="deleteItem">
...
const emit = defineEmits(['delete-city', 'to-detail'])
